package com.xz.tabnavigate_lib;
...
public class TabNavigateLayout extends LinearLayout {
	...
	protected void onAttachedToWindow() {
		...
		LayoutParams warpParams = new LayoutParams(
...
//		itemWidth = displayWidth / mItems.size(); // 设置水平动画平移大小
		...
		FrameLayout.LayoutParams fragmeParams = new FrameLayout.LayoutParams(
				android.view.ViewGroup.LayoutParams.MATCH_PARENT,
				android.view.ViewGroup.LayoutParams.MATCH_PARENT);
		frameLayout.setLayoutParams(fragmeParams);
		FrameLayout.LayoutParams selectedImageParams = new FrameLayout.LayoutParams(
				android.view.ViewGroup.LayoutParams.MATCH_PARENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
